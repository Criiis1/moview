$(document).ready(function () {
  ...
  localStorage.getItem("RecentsList") == `{"results":{}}` || !localStorage.getItem("RecentsList") ? document.getElementById("text_title_page").innerHTML = `New Content` : document.getElementById("text_title_page").innerHTML = `Recentes`; 
